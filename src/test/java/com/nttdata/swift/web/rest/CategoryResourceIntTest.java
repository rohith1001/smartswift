...
import com.nttdata.swift.domain.Category;
import com.nttdata.swift.repository.CategoryRepository;
...
public class CategoryResourceIntTest {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCategory_name()).isEqualTo(DEFAULT_CATEGORY_NAME);
    }
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].category_name").value(hasItem(DEFAULT_CATEGORY_NAME.toString())));
    }
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.category_name").value(DEFAULT_CATEGORY_NAME.toString()));
    }
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getCategory_name()).isEqualTo(UPDATED_CATEGORY_NAME);
    }
