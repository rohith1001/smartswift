...
import com.nttdata.swift.domain.Ticket;
import com.nttdata.swift.repository.TicketRepository;
...
public class TicketResourceIntTest {
    ...
    public void createTicket() throws Exception {
        ...
        assertThat(testTicket.getTicket_type()).isEqualTo(DEFAULT_TICKET_TYPE);
    }
    ...
    public void getAllTickets() throws Exception {
        ...
        restTicketMockMvc.perform(get("/api/tickets?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ticket_type").value(hasItem(DEFAULT_TICKET_TYPE.toString())));
    }
    ...
    public void getTicket() throws Exception {
        ...
        restTicketMockMvc.perform(get("/api/tickets/{id}", ticket.getId()))
            ...
            .andExpect(jsonPath("$.ticket_type").value(DEFAULT_TICKET_TYPE.toString()));
    }
    ...
    public void updateTicket() throws Exception {
        ...
        updatedTicket
            .ticket_type(UPDATED_TICKET_TYPE);
        ...
        Ticket testTicket = ticketList.get(ticketList.size() - 1);
        assertThat(testTicket.getTicket_type()).isEqualTo(UPDATED_TICKET_TYPE);
    }
