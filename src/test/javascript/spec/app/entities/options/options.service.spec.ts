...
describe('Service Tests', () => {
    describe('Options Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OptionsService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Options(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Options', async () => {
            ...
            it('should update a Options', async () => {
                const returnedFromService = Object.assign(
                    {
                        option_type: 'BBBBBB'
                    },
            ...
            it('should delete a Options', async () => {
